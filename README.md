...
A single-file documentation site template for [Bluestone PIM Labs](https://bluestone-labs-landing.vercel.app) projects. Fork it to get a sidebar, dark mode, copyable markdown source, and consistent visual identity with other Labs projects — no build step, no dependencies.
...
## Listing your project on Bluestone PIM Labs
